...
def trackScoreOnScreen():
    ...
    pen.goto(0, 260)
    pen.write("Score: 0  High Score: 0", align= "center", font=("freestyle script", 24, "bold italic"))
    return pen
...
def handleCollisionWithFood(head, trackScore, food):
    ...
    # Update trackScore
    trackScore.clear()
    trackScore.write("Score: {}  High Score: {}".format(score, high_score), align="center", font=("freestyle script", 24, "italic bold")) 
